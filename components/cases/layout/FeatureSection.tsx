...
export default function FeatureSection({ heading, features }: Props) {
  return (
    <div className="flex flex-col lg:flex-row lg:gap-12">
      {/* Left: sticky heading */}
      <div className="lg:w-[280px] lg:shrink-0 lg:sticky lg:top-32 lg:self-start mb-6 lg:mb-0">
        <h2 className="text-2xl md:text-3xl font-pretendard font-bold text-foreground leading-tight line-clamp-2">
          {heading}
        </h2>
      </div>
      ...
      <div className="flex-1 min-w-0 space-y-12">
        {features.map((feat, i) => (
          <div key={`feat-${i}`}>
            <h3 className="text-lg font-pretendard font-bold text-foreground mb-2">
              {feat.title}
            </h3>
